...
def deleteItem(hold_num):
    ...
    listHeader = ("Hold Num:", "Customer Name:", "Date Made:", "Delivery Address:", "Phone#:", "Total Cost")
    print('{0:>5} {1:>23} {2:>12} {3:>25} {4:>20} {5:>20}'.format(*listHeader))
    list = (order.get_hold_num(), str(customerDAO.select_by_phone(order.get_phone_num()).get_lname()) + ", " + str(
        customerDAO.select_by_phone(order.get_phone_num()).get_fname()), order.get_date_made(),
            order.get_delivery_address(), order.get_phone_num(), order.get_total_cost())
    print('{0:>5} {1:>26} {2:>12} {3:>25} {4:>20} {5:>20}'.format(*list))
    print("")
    items = itemDAO.select_by_hold_num(hold_num)
    listHeader = ("NTD#:", "Quantity:", "Cost of Product:", "Carton Count:", "Piece count:")
            ...
            while True:
                ...
                if choice2 == "1":
                    ...
                    if valid_hold_num == False:
                        ...
                        listHeader = ("Hold Num:", "Customer Name:", "Date Made:", "Delivery Address:", "Phone#:", "Total Cost")
                        print('{0:>5} {1:>23} {2:>12} {3:>25} {4:>20} {5:>20}'.format(*listHeader))
                        list = (order.get_hold_num(), str(customerDAO.select_by_phone(order.get_phone_num()).get_lname()) + ", " + str(customerDAO.select_by_phone(order.get_phone_num()).get_fname()), order.get_date_made(), order.get_delivery_address(), order.get_phone_num(), order.get_total_cost())
                        print('{0:>5} {1:>26} {2:>12} {3:>25} {4:>20} {5:>20}'.format(*list))
                        print("")
                        items = itemDAO.select_by_hold_num(hold_num)
                        listHeader = ("NTD#:", "Quantity:", "Cost of Product:", "Carton Count:", "Piece count:")
                        ...
                        while True:
                            ...
                            if choice3 == "1":
                                ...
                                if valid_hold_num == False:
                                    ...
                                    order = customerOrderDAO.select_by_hold_number(hold_num)
                                    listHeader = (
                                    "Hold Num:", "Customer Name:", "Date Made:", "Delivery Address:", "Phone#:", "Total Cost of Order")
                                    print('{0:>5} {1:>23} {2:>12} {3:>25} {4:>20} {5:>20}'.format(*listHeader))
                                    list = (order.get_hold_num(), str(customerDAO.select_by_phone(order.get_phone_num()).get_lname()) + ", " + str(customerDAO.select_by_phone(order.get_phone_num()).get_fname()), order.get_date_made(), order.get_delivery_address(), order.get_phone_num(), order.get_total_cost())
                                    print(print('{0:>5} {1:>26} {2:>12} {3:>25} {4:>20} {5:>20}'.format(*list)))
                                    items = itemDAO.select_by_hold_num(hold_num)
                                    print("")
                                    listHeader = ("NTD#:", "Quantity:", "Cost of Product:", "Carton Count:", "Piece count:")
                                    print('{0:>15} {1:>17} {2:>22} {3:>18} {4:>15}'.format(*listHeader))
